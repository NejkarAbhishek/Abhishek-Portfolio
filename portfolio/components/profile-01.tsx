    ...
    <div className="w-full flex justify-center">
      ...
      >
        ...
        <div className="relative mb-2 group flex-shrink-0">
          <div className="w-32 h-32 rounded-full bg-gradient-to-tr from-blue-400 via-purple-400 to-pink-400 p-1 shadow-lg group-hover:scale-105 transition-transform duration-300">
            <img
              src={AVATAR_URL}
              alt="Abhishek Nejkar"
              width={128}
        ...
        {/* Name, Role, Location, Actions */}
        <div className="flex flex-col items-center sm:items-start flex-1 w-full">
          <span className={`text-2xl sm:text-4xl font-extrabold ${nameColor} drop-shadow-sm`}>Abhishek Nejkar</span>
          ...
          <div className="flex items-center gap-4 mt-2">
            ...
            {/* Mail */}
            <a href="mailto:your@email.com" aria-label="Mail" className="transition flex items-center justify-center">
