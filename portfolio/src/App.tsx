    ...
    <main className="relative min-h-screen w-full overflow-x-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="w-full flex flex-col items-center justify-center min-h-screen py-16">
          {/* Profile Card - 40% width or max-w-md */}
          <div className="w-full max-w-xl" style={{width: '40vw', minWidth: 384, maxWidth: 576}}>
            <Profile01 theme={theme} />
            {/* Heading Badge below Profile Card */}
            <div className="flex justify-start mt-4">
              <span className={`text-lg font-bold px-4 py-2 rounded-lg border shadow-sm ${theme === "dark" ? "bg-zinc-800 text-zinc-100 border-zinc-700" : "bg-white text-zinc-900 border-zinc-200"}`}>Experience</span>
            </div>
            ...
            <div className="flex justify-start mt-8">
              <span className={`text-lg font-bold px-4 py-2 rounded-lg border shadow-sm ${theme === "dark" ? "bg-zinc-800 text-zinc-100 border-zinc-700" : "bg-white text-zinc-900 border-zinc-200"}`}>Skills</span>
            </div>
            {/* Skills Section Grid */}
            <SkillsSection theme={theme} />
            {/* Projects Badge below Skills Section */}
            <div className="flex justify-start mt-8">
              <span className={`text-lg font-bold px-4 py-2 rounded-lg border shadow-sm ${theme === "dark" ? "bg-zinc-800 text-zinc-100 border-zinc-700" : "bg-white text-zinc-900 border-zinc-200"}`}>Projects</span>
            </div>
          </div>
          {/* Card Stack - 40% width or max-w-xl, below profile card */}
          <div className="w-full max-w-xl mt-8 flex flex-col items-center" style={{width: '40vw', minWidth: 384, maxWidth: 576, position: 'relative'}}>
