        ...
        <div className="w-full flex flex-col items-center justify-center min-h-screen py-16">
          ...
          <div className="w-full max-w-2xl mt-8 grid grid-cols-1 sm:grid-cols-2 gap-6" style={{width: '76vw', minWidth: 460, maxWidth: 690}}>
            ...
            <ProjectCard
              ...
              websiteUrl="https://scribbly.example.com"
            ...
            <ProjectCard
              ...
              websiteUrl="https://hobbyhub.example.com"
              githubUrl="https://github.com/NejkarAbhishek/Hobby-Hub"
              theme={theme}
            />
            <ProjectCard
              imageUrl="images/ForzaFerrari.png"
              title="Forza Ferrari"
              description="A Ferrari F1 team website"
              tags={["SpringBoot", "ReactJS", "MySQL"]}
              websiteUrl="https://hobbyhub.example.com"
              githubUrl="https://github.com/NejkarAbhishek/Forza-Ferrari"
              theme={theme}
            />
            <ProjectCard
              imageUrl="images/Corsa.png"
              title="CorsaF1"
              description="A F1 Race analysis platform"
              tags={["GoLang", "PostgresSQL", "Docker"]}
              githubUrl="https://github.com/NejkarAbhishek/CorsaF1"
              theme={theme}
            />
            <ProjectCard
              imageUrl="images/CrisisConnect.png"
              title="Crisis Connect"
              description="A Crisis Management System"
              tags={["Java", "Java Swing"]}
              githubUrl="https://github.com/NejkarAbhishek/Crisis-Connect"
              theme={theme}
            />
            <MoreProjectsCard theme={theme} href="https://github.com/NejkarAbhishek" />
          </div>
